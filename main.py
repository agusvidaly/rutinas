...
def ejercicio(nombre, duracion, imagen):
    return {
        "nombre": nombre,
        "preparacion": 3,
        "duracion": duracion,
...
MAINS_VERS_LE_CIEL = ejercicio("manos al cielo", 30, "imagenes/manosalcielo.png")
FLEXION_AVANT = ejercicio("flexión hacia adelante", 30, "imagenes/flexionhaciaadelante.png")
FENTE_AVANT_DROIT = ejercicio("estocada frontal derecha", 30, "imagenes/estocadafrontal.png")
FENTE_AVANT_GAUCHE = ejercicio("estocada frontal izquierda", 30, "imagenes/estocadafrontal.png")
CHIEN_FACE_AU_CIEL = ejercicio("perro boca arriba", 30, "imagenes/perrobocaarriba.png")
POSTURE_DU_ENFANT = ejercicio("postura del niño", 30,"imagenes/posturadelniño.png")
CHIEN_TETE_EN_BAS = ejercicio("perro boca abajo", 30, "imagenes/perrobocaabajo.png")
POSTURE_DU_GRAND_ANGLE = ejercicio("postura del gran ángulo", 30, "imagenes/posturadelgranangulo.png")
FLEXION_LATERALES_DYNAMIQUES = ejercicio("flexiones laterales dinámicas", 30, "imagenes/flexioneslaterales.png")
CERCLES_AVEC_LES_BRAS = ejercicio("círculos con los brazos", 30, "imagenes/circuloscnlosbrazos.png")
BALANCEMENT_DE_BRAS = ejercicio("balanceo de brazos", 20, "imagenes/balanceodebrazos.png")
TORSION_DU_TORSE = ejercicio("torsión del torso", 30, "imagenes/torsiondetorso.png")
ROULEMENTS_DU_COU = ejercicio("círculo con el cuello", 15, "imagenes/circuloconelcuello.png") 
CERCLES_DE_HANCHES = ejercicio("círculo con la cadera", 30, "imagenes/circuloconlacadera.png")
FLEXION_DYNAMIQUE_DES_JAMBES_VERS_AVANT = ejercicio("flexión dinámica de las piernas", 45, "imagenes/flexiondinamicadepiernas.png") #no existe
SCOOPS_POR_LES_IQUIO_JAMBIERS = ejercicio("estirar los isquiotibiales", 30, "imagenes/estirrlosisquiotibiales.png") #no existe
OUVRE_PORTE = ejercicio("apertura de puerta", 30, "imagenes/aberturadepuerta.png") #no existe
CERCLE_DE_TORSE_A_JAMBES_LARGES = ejercicio("cercle de torse à jambes larges", 30, "imagenes/circuloconelcuello.png") #no existe
CALIN_DE_GENOUX = ejercicio("abrazo de rodillas", 30, "imagenes/circuloconelcuello.png") #no existe
CERCLES_AVEC_LES_GENOUX = ejercicio("círculos con las rodillas", 30, "imagenes/circuloconelcuello.png") #no existe
FLEXION_AVANT_NOCHE = ejercicio("flexión hacia adelante", 30, "imagenes/circuloconelcuello.png") #no existe
GENOUX_A_LA_POITRINE = ejercicio("rodillas al pecho", 30, "imagenes/circuloconelcuello.png") #no existe
BEBE_HEREUX = ejercicio("bébé hereux", 30, "imagenes/circuloconelcuello.png") #no existe
PAPILLON_INCLINE = ejercicio("papillon incliné", 30, "imagenes/circuloconelcuello.png") #no existe
TORSION_ALLONGEE_DROIT = ejercicio("torsion alongeé droit", 30, "imagenes/circuloconelcuello.png") #no existe
TORSION_ALLONGEE_GAUCHE = ejercicio("torsion alongeé gauche", 30, "imagenes/circuloconelcuello.png") #no existe
ESTIREMENT_DE_QUAD_DROIT = ejercicio("estirement des quad droit", 30, "imagenes/circuloconelcuello.png") #no existe
ESTIREMENT_DE_QUAD_GAUCHE = ejercicio("estirement des quad gauche", 30, "imagenes/circuloconelcuello.png") #no existe
JAMBES_CONTRE_LE_MUR = ejercicio("jambes contre le mur", 30, "imagenes/circuloconelcuello.png") #no existe
JAMBES_GRAND_ANGLE_CONTRE_LE_MUR = ejercicio("jambes grand angle contre le mur",30, "imagenes/circuloconelcuello.png") #no existe
